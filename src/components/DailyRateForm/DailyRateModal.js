    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formGroup}>
          <input className={styles.input} type="text" name="filter" value={inputValues} onChange={handleChange} />
          <svg className={styles.formGroup__icon}>
            <use href={sprite + "#icon-search"} />
          </svg>
        </div>
        <p className={styles.products}>Продукты, которые вам не рекомендуется употреблять</p>
